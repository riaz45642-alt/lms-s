export const faqs = [
  { q: "What subscription plans are available, and which is best for me?", a: "EduSphere offers monthly, annual and two-year plans. Each plan includes full access to every worksheet across all subjects and year groups. Pick the term that fits your budget — review the details on our pricing page and choose what aligns with your needs." },
  { q: "How can I sign up for a paid parent account?", a: "Click \"Sign up\", choose the Parent option, select a plan, and complete checkout. You'll get instant access to the full worksheet library." },
